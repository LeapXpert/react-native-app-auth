    ...
    private static class TokenRequestTask
        ...
        protected JSONObject doInBackground(Void... voids) {
            ...
            try {
                ...
                HttpPost httpPost = new HttpPost(mRequest.configuration.tokenEndpoint.toString());
...
//                httpPost.addHeader("Content-Length", String.valueOf(queryData.length()));
...
//                wr.flush();
                ...
                if (res.getStatusLine().getStatusCode() >= HttpURLConnection.HTTP_OK
                        && res.getStatusLine().getStatusCode() < HttpURLConnection.HTTP_MULT_CHOICE) {
